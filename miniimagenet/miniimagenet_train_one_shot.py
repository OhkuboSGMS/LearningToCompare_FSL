...
def main():
    ...
    print(torchinfo.summary(relation_network, (375, 128, 19, 19)))
    print(torchinfo.summary(feature_encoder, (375, 3, 84, 84)))
    ...
    #             SAMPLE_NUM_PER_CLASS) + "shot.pkl"), map_location=CUDA_DEVICE))
    ...
    #         str("./models/miniimagenet_relation_network_" + str(CLASS_NUM) + "way_" + str(
    #             SAMPLE_NUM_PER_CLASS) + "shot.pkl"), map_location=CUDA_DEVICE))
    ...
    for episode in range(EPISODE):
        ...
        # print("Image Sample Shape:",samples.shape)
        # calculate features
